...
axs[0].axhline(0,0,0.5, c='w', linestyle='solid', lw=1, zorder=0,
...
# axs[1].contour(X, Y, Vdata, '-', levels=np.linspace(-6, 6, 70),
#                          colors=cdata, linewidths=1, linestyles='solid')

# remove the lines on discontinuity
axs[1].axhline(0,0,0.5, c='w', linestyle='solid', lw=1,
    solid_capstyle='round')
